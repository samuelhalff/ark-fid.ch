...
// SEO Metadata Updates based on requirements
const updates = {
  en: {
    pages: {
      '/': {
      ...
      '/services/accounting': {
        ...
        description: 'Professional accounting and bookkeeping for SMEs in Geneva. Ark Fiduciaire handles financial statements, reporting, and advisory.',
      ...
      '/services/payroll': {
        ...
        description: 'Outsourced payroll and HR services in Geneva. Ark Fiduciaire ensures compliance and efficiency for your business.',
  ...
  fr: {
    pages: {
      ...
      '/services/accounting': {
        ...
        description: 'Expert en comptabilité pour PME et indépendants à Genève. Ark Fiduciaire assure votre tenue comptable, bouclements annuels et conseils financiers.',
      ...
      '/services/payroll': {
        ...
        description: 'Confiez la gestion de vos salaires à Ark Fiduciaire. Paie, assurances sociales et conformité légale pour PME à Genève.',
...
// Apply updates
console.log('Updating metadata files with SEO improvements...\n');
