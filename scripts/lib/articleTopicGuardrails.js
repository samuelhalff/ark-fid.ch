...
const TOPIC_KEYWORDS = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /registre des parts sociales/i,
      /ayant[s]? droit[s]? [ée]conomique[s]?/i,
      /b[ée]n[ée]ficiaire effectif/i,
      /\bUBO\b/i,
      /proc[eè]s[- ]?verbal/i,
      /modification statutaire/i,
      /signature collective/i,
      /signature individuelle/i,
    ],
  },
  {
    topic: "domiciliation",
    ...
    patterns: [
      /domicil/i,
      /si[èe]ge social/i,
      /adresse commerciale/i,
      /attestation de domiciliation/i,
      /substance/i,
      /courrier/i,
      /bo[iî]te aux lettres/i,
      /direction locale/i,
    ],
  },
  {
