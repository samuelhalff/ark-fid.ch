...
const OdooPresentation = () => {
  ...
  return (
    ...
    >
      ...
      {(t("Odoo.Presentation.Intro", { returnObjects: true }) as string[]).map(
        (text, idx) => (
      ...
      <StylishList
        items={t("Odoo.Presentation.List", { returnObjects: true }) as string[]}
        Icon={CheckCircle}
      ...
      {(
        t("Odoo.Presentation.Strengths", { returnObjects: true }) as Array<{
          Title: string;
          Desc: string;
        }>
      ).map((item, idx) => (
